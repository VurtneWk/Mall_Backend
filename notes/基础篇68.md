...
![image-20250110202918872](https://gitee.com/vurtnewk/typora-image/raw/master/images03/202501102029047.png) 
...
![image-20250111003848086](https://gitee.com/vurtnewk/typora-image/raw/master/images03/202501110038234.png) 
...
![image-20250111010130587](https://gitee.com/vurtnewk/typora-image/raw/master/images03/202501110101719.png) 

![image-20250111010221314](https://gitee.com/vurtnewk/typora-image/raw/master/images03/202501110102462.png)
...
销售属性请求的接口：http://localhost:88/api/product/attr/sale/list/0?t=1736581760356&page=1&limit=10&key=

基本属性请求的接口：http://localhost:88/api/product/attr/base/list/0?t=1736581799002&page=1&limit=10&key=

只有 sale和base的区别，所以可以修改为使用同一个方法
...
比如：queryBaseAttrPage、saveAttrVO、getAttrInfo、updateAttrVO 的方法都需要判断是否为基础属性，基础属性才用保存、修改关联的分组等信息